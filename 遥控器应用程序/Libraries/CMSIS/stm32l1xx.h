...
#define HSE_VALUE    ((uint32_t)20000000) /*!< Value of the External oscillator in Hz *///马如意，2015.04.24修改
#endif
...
/** @addtogroup Exported_types
  * @{
  */  
/*!< STM32F10x Standard Peripheral Library old types (maintained for legacy purpose) *///2015.05.05,马如意增加类型定义
typedef int32_t  s32;
typedef int16_t s16;
typedef int8_t  s8;
